...
{
    let ray = game.startShapeTestRay(pointA.x, pointA.y, pointA.z, pointB.x, pointB.y, pointB.z, flags, alt.getLocalPlayer().scriptID, 0);
    return game.getShapeTestResult(ray);
}
export function raycastExPointToPoint(pointA, pointB, flags)
{
    let ray = game.startShapeTestRayEx(pointA.x, pointA.y, pointA.z, pointB.x, pointB.y, pointB.z, flags, alt.getLocalPlayer().scriptID, 0);
